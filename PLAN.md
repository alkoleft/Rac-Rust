...
- Output: **Markdown spec** at `docs/rac_message_formats.md`.
...
## Deliverables
1. `docs/rac_message_formats.md` (spec)
...
- Method map in `docs/rac_cli_method_map.generated.md`
- Existing notes in `docs/rac_protocol_notes.md`, `skills/onec-protocol-reverse/references/rac_method_map.md`

**Steps**
1. Enumerate read/info commands from `docs/rac_cli_method_map.generated.md`.
...
**Output**
- `docs/rac_message_formats.md` with one section per command:
...
- Tests that:
  ...
  - Method IDs match `docs/rac_cli_method_map.generated.md`
...
## Acceptance Criteria
- `docs/rac_message_formats.md` lists every read/info command with:
