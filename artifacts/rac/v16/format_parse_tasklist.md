...
**Counter**
- [ ] `rac counter list`: захваты с разными enum (`group`, `filter-type`, `duration`, и др.), подтвердить кодировки. — Статус: захват [~], анализ [x], описание [x]
- [ ] `rac counter info`: захваты с разными enum (`group`, `filter-type`, `duration`, и др.), подтвердить кодировки. — Статус: захват [~], анализ [x], описание [x]
- [ ] `rac counter values`: захваты с разными enum (`group`, `filter-type`, `duration`, и др.), подтвердить кодировки. — Статус: захват [~], анализ [x], описание [x]
- [ ] `rac counter accumulated-values`: захваты с разными enum (`group`, `filter-type`, `duration`, и др.), подтвердить кодировки. — Статус: захват [~], анализ [x], описание [x]
- [ ] `rac counter update`: получить захват запроса/ответа, восстановить порядок полей. — Статус: захват [x], анализ [x], описание [x]
- [ ] `rac counter clear`: получить захват запроса/ответа, восстановить порядок полей. — Статус: захват [x], анализ [x], описание [x]
- [ ] `rac counter remove`: получить захват запроса/ответа, восстановить порядок полей. — Статус: захват [x], анализ [x], описание [x]

**Limit**
- [ ] `rac limit list`: захваты с разными `action` и ненулевыми лимитами, подтвердить enum и поля. — Статус: захват [~], анализ [x], описание [x]
- [ ] `rac limit info`: захваты с разными `action` и ненулевыми лимитами, подтвердить enum и поля. — Статус: захват [~], анализ [x], описание [x]
- [ ] `rac limit update`: получить захват запроса/ответа, восстановить порядок полей. — Статус: захват [x], анализ [x], описание [x]
- [ ] `rac limit remove`: получить захват запроса/ответа, восстановить порядок полей. — Статус: захват [x], анализ [x], описание [x]
