...
- [ ] `rac agent version`: получить захват запроса/ответа и подтвердить порядок/формат ответа. — Статус: захват [x], анализ [ ], описание [ ]
- [ ] `rac agent admin register`: получить захват запроса/ответа, восстановить порядок полей. — Статус: захват [x], анализ [ ], описание [ ]
- [ ] `rac agent admin remove`: получить захват запроса/ответа, восстановить порядок полей. — Статус: захват [x], анализ [ ], описание [ ]
...
- [ ] `rac connection list`: захват с `--process` для определения порядка полей запроса. — Статус: захват [x], анализ [ ], описание [ ]
- [ ] `rac connection list`: захват с `--infobase` для определения порядка полей запроса. — Статус: захват [x], анализ [ ], описание [ ]
- [ ] `rac connection list`: захват с `--infobase-user` для определения порядка полей запроса. — Статус: захват [x], анализ [ ], описание [ ]
- [ ] `rac connection list`: захват с `--infobase-pwd` для определения порядка полей запроса. — Статус: захват [x], анализ [ ], описание [ ]
- [ ] `rac connection info`: захват запроса/ответа для определения порядка полей запроса. — Статус: захват [x], анализ [ ], описание [ ]
- [ ] `rac connection disconnect`: получить захват запроса/ответа, восстановить порядок полей. — Статус: захват [x], анализ [ ], описание [ ]
...
- [ ] `rac infobase info`: получить v11-захват payload и сопоставить неизвестные строки/байты и `tail[28]` с полями. — Статус: захват [x], анализ [ ], описание [ ]
- [ ] `rac infobase summary info`: получить захват и подтвердить формат ответа. — Статус: захват [x], анализ [ ], описание [ ]
- [ ] `rac infobase summary update`: получить захват запроса/ответа, восстановить порядок полей. — Статус: захват [x], анализ [ ], описание [ ]
...
- [ ] `rac lock list --session`: захват, чтобы проверить наличие дополнительных полей в запросе. — Статус: захват [x], анализ [ ], описание [ ]
