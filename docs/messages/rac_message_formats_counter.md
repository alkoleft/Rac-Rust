...
Payload example:
- `artifacts/counter_info_codex_tmp_response.hex`

RAC output reference:
- `artifacts/counter_info_codex_tmp_rac.out`
...
Payload example:
- `artifacts/counter_update_codex_tmp_response.hex`

RAC output reference:
- `artifacts/counter_update_codex_tmp_rac.out`
...
| `cluster-pwd` | string | yes (in auth/context `0x09`) | 3 |
| `name` | string | yes | 4 |
| `collection-time` | u64_be | yes | 5 |
| `group` | enum (u8) | yes | 6 |
| `filter-type` | enum (u8) | yes | 7 |
| `filter` | string | yes | 8 |
| `duration` | enum (u8) | yes | 9 |
| `cpu-time` | enum (u8) | yes | 10 |
| `duration-dbms` | enum (u8) | yes | 11 |
| `service` | enum (u8) | yes | 12 |
| `memory` | enum (u8) | yes | 13 |
| `read` | enum (u8) | yes | 14 |
| `write` | enum (u8) | yes | 15 |
| `dbms-bytes` | enum (u8) | yes | 16 |
| `call` | enum (u8) | yes | 17 |
| `number-of-active-sessions` | enum (u8) | yes | 18 |
| `number-of-sessions` | enum (u8) | yes | 19 |
| `descr` | string | yes | 20 |
...
Payload example:
- `artifacts/counter_values_codex_tmp_response.hex`

RAC output reference:
- `artifacts/counter_values_codex_tmp_rac.out`
...
| `object` | string | yes | 1 |
| `collection-time` | u64_be | yes | 2 |
| `duration` | u64_be | yes | 3 |
| `cpu-time` | u64_be | yes | 4 |
| `memory` | u64_be | yes | 5 |
| `read` | u64_be | yes | 6 |
| `write` | u64_be | yes | 7 |
| `duration-dbms` | u64_be | yes | 8 |
| `dbms-bytes` | u64_be | yes | 9 |
| `service` | u64_be | yes | 10 |
| `call` | u64_be | yes | 11 |
| `number-of-active-sessions` | u64_be | yes | 12 |
| `number-of-sessions` | u64_be | yes | 13 |
| `time` | datetime | yes | 14 |
...
| `cluster` | UUID | yes | 1 |
| `counter` | string | yes | 2 |
| `object` | string | yes (empty, `len=0`) | 3 |
| `cluster-user` | string | yes (in auth/context `0x09`) | 4 |
| `cluster-pwd` | string | yes (in auth/context `0x09`) | 5 |
...
Payload example:
- `artifacts/counter_accumulated_values_codex_tmp_response.hex`

RAC output reference:
- `artifacts/counter_accumulated_values_codex_tmp_rac.out`
...
Payload example:
- `artifacts/counter_clear_codex_tmp_response.hex`

RAC output reference:
- `artifacts/counter_clear_codex_tmp_rac.out`
...
Payload example:
- `artifacts/counter_remove_codex_tmp_response.hex`

RAC output reference:
- `artifacts/counter_remove_codex_tmp_rac.out`
