...
Payload example:
- `artifacts/process_list_response.hex`

RAC output reference:
- `artifacts/process_list_rac.out`
...
Payload example:
- `artifacts/process_list_licenses_response.hex`

RAC output reference:
- `artifacts/process_list_licenses_rac.out`
...
Payload example:
- `artifacts/process_info_response.hex`

RAC output reference:
- `artifacts/process_info_rac.out`
...
Payload example:
- `artifacts/process_info_licenses_response.hex`

RAC output reference:
- `artifacts/process_info_licenses_rac.out`
