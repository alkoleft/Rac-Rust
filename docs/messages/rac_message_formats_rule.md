...
Payload example:
- `artifacts/rule_apply_response.hex`

RAC output reference:
- `artifacts/rule_apply_rac.out`
...
Payload example:
- `artifacts/rule_list_response.hex`

RAC output reference:
- `artifacts/rule_list_rac.out`
...
Payload example:
- `artifacts/rule_info_response.hex`

RAC output reference:
- `artifacts/rule_info_rac.out`
...
Payload example:
- `artifacts/rule_insert_response.hex`

RAC output reference:
- `artifacts/rule_insert_rac.out`
...
Payload example:
- `artifacts/rule_update_response.hex`

RAC output reference:
- `artifacts/rule_update_rac.out`
...
Payload example:
- `artifacts/rule_remove_response.hex`

RAC output reference:
- `artifacts/rule_remove_rac.out`
