...
def main() -> None:
    ...
    plan.add_argument("--registry", default="docs/modes/rac_modes_registry.md")
    plan.add_argument("--out-md", default="artifacts/rac_impl_plan.md")
    plan.add_argument("--out-json", default="artifacts/rac_impl_plan.json")
    ...
    implement.add_argument("--registry", default="docs/modes/rac_modes_registry.md")
