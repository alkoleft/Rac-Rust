...
def main() -> None:
    ...
    parser.add_argument("--doc", required=True, help="Doc file to update, e.g. docs/messages/rac_message_formats_server.md")
    parser.add_argument("--artifacts-dir", default="artifacts", help="Artifacts directory.")
    parser.add_argument(
        "--env-file",
        default="docs/.private/rac_env.txt",
    ...
    parser.add_argument("--update-registry", action="store_true", help="Update docs/modes/rac_modes_registry.md.")
    parser.add_argument(
        "--all",
        action="store_true",
